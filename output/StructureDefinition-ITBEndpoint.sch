...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Endpoint">
      ...
      <sch:assert test="count(f:header) &gt;= 1">header: minimum cardinality of 'header' is 1</sch:assert>
      <sch:assert test="count(f:header) &lt;= 1">header: maximum cardinality of 'header' is 1</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
